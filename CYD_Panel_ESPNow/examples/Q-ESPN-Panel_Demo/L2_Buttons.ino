...
//--------------------------------------------------------------------------------------------
void L2_ButtonsCallback(CYD_channel event)
{  
  ...
  switch (event) 
  {
    ...
    case CYD_Button_6:
      ...
      Panel.send(CYD_Reset, CYD_LAYOUT_3);
      break;
...
void L2_ButtonsInit()
{
  Panel.send(CYD_ApplicationName, "CYD_Panel L2 Buttons");
  ...
  Panel.send(CYD_Led_10, CYD_COLOR, CYD_PURPLE);
  Panel.send(CYD_Led_11, CYD_COLOR, CYD_BLUE);

  Panel.send(CYD_Led_12, CYD_COLOR, CYD_PURPLE);
  Panel.send(CYD_Led_13, CYD_COLOR, CYD_DBLUE);
  Panel.send(CYD_Led_14, CYD_COLOR, CYD_LBLUE);
  Panel.send(CYD_Led_15, CYD_COLOR, CYD_BLUE);
  Panel.send(CYD_Led_15, CYD_COLOR, CYD_GREEN);
